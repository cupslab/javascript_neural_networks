...
},{"cwise-compiler":6}],11:[function(require,module,exports){
...
},{"./decode":16,"./decoder":17,"./encode":19,"./encoder":20}],13:[function(require,module,exports){
...
},{"./decode-buffer":15,"./read-core":24}],17:[function(require,module,exports){
...
},{"./decode-buffer":15,"./read-core":24,"event-lite":11}],18:[function(require,module,exports){
(function (Buffer){
...
},{"./encode-buffer":18,"./write-core":27}],20:[function(require,module,exports){
...
},{"./encode-buffer":18,"./write-core":27,"event-lite":11}],21:[function(require,module,exports){
...
},{"./decode":16,"./encode":19,"./ext":23,"buffer":1}],23:[function(require,module,exports){
...
},{"./ext-buffer":21}],24:[function(require,module,exports){
...
},{"./common":14,"./read-format":25,"./read-token":26}],25:[function(require,module,exports){
(function (Buffer){
...
},{"./buffer-lite":13,"./common":14,"./ext-preset":22,"./read-core":24,"buffer":1}],26:[function(require,module,exports){
...
},{"./read-format":25}],27:[function(require,module,exports){
...
},{"./write-type":29}],28:[function(require,module,exports){
(function (Buffer){
...
},{"./buffer-lite":13,"./write-uint8":30,"buffer":1}],29:[function(require,module,exports){
(function (Buffer){
...
},{"./buffer-lite":13,"./ext-buffer":21,"./ext-preset":22,"./write-core":27,"./write-token":28,"./write-uint8":30,"buffer":1}],30:[function(require,module,exports){
...
},{"cwise/lib/wrapper":10,"dup":33}],35:[function(require,module,exports){
...
},{"iota-array":36,"is-buffer":37}],36:[function(require,module,exports){
...
},{"ndarray-ops":32}],39:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.timeDistributedDense=exports.repeatVector=exports.rJZS3Layer=exports.rJZS2Layer=exports.rJZS1Layer=exports.rGRULayer=exports.rLSTMLayer=exports.denseLayer=void 0;var _dense=require("./layers/dense"),_recurrent=require("./layers/recurrent");exports.denseLayer=_dense.denseLayer,exports.rLSTMLayer=_recurrent.rLSTMLayer,exports.rGRULayer=_recurrent.rGRULayer,exports.rJZS1Layer=_recurrent.rJZS1Layer,exports.rJZS2Layer=_recurrent.rJZS2Layer,exports.rJZS3Layer=_recurrent.rJZS3Layer,exports.repeatVector=_recurrent.repeatVector,exports.timeDistributedDense=_recurrent.timeDistributedDense;
},{"./layers/dense":40,"./layers/recurrent":41}],40:[function(require,module,exports){
...
},{"../functions/activations":38,"../lib/cpu/matrix-vector-product":42,"../lib/ndarray-pack":43,"ndarray":35,"ndarray-ops":32}],41:[function(require,module,exports){
...
},{"../functions/activations":38,"../lib/cpu/matrix-vector-product":42,"../lib/ndarray-pack":43,"ndarray":35,"ndarray-ops":32}],42:[function(require,module,exports){
...
},{"ndarray-blas-level1":31}],43:[function(require,module,exports){
...
},{"cwise-compiler":6,"ndarray":35}],44:[function(require,module,exports){
(function (process){
"use strict";function _typeof2(e){return e&&"undefined"!=typeof Symbol&&e.constructor===Symbol?"symbol":typeof e}function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r["default"]=e,r}function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _typeof(e){return e&&"undefined"!=typeof Symbol&&e.constructor===Symbol?"symbol":"undefined"==typeof e?"undefined":_typeof2(e)}function recursive_translate(e,r,t){for(var a in e){var n=e[a];if("number"==typeof n){var i;t?(i=n>>1,n%2==1&&(i*=-1),e[a]=i/r):i=n,e[a]=i/r}else"object"===("undefined"==typeof n?"undefined":_typeof(n))&&recursive_translate(n,r,t)}return e}function unpack_from_msg(e,r,t){for(var a=_msgpackLite2["default"].decode(new Uint8Array(e)),n=[],i=0;i<a.length;i++){var o=a[i];-1!=weight_first_list.indexOf(o.layerName)&&(o.parameters=recursive_translate(o.parameters,r,t)),n.push(o)}return n}var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,t,a){return t&&e(r.prototype,t),a&&e(r,a),r}}();Object.defineProperty(exports,"__esModule",{value:!0});var _ndarrayPack=require("./lib/ndarray-pack"),_ndarrayPack2=_interopRequireDefault(_ndarrayPack),_ndarrayUnpack=require("ndarray-unpack"),_ndarrayUnpack2=_interopRequireDefault(_ndarrayUnpack),_msgpackLite=require("msgpack-lite"),_msgpackLite2=_interopRequireDefault(_msgpackLite),_layers=require("./layers"),layerFuncs=_interopRequireWildcard(_layers),weight_first_list=["timeDistributedDense","denseLayer","embeddingLayer","batchNormalizationLayer","parametricReLULayer","parametricSoftplusLayer","rLSTMLayer","rGRULayer","rJZS1Layer","rJZS2Layer","rJZS3Layer","convolution2DLayer","convolution1DLayer"],NeuralNet=function(){function e(r){_classCallCheck(this,e),r=r||{},"float32"===r.arrayType?this._arrayType=Float32Array:"float64"===r.arrayType?this._arrayType=Float64Array:this._arrayType=Array,"object"===("undefined"==typeof window?"undefined":_typeof(window))?this._environment="browser":"function"==typeof importScripts?this._environment="webworker":"object"===("undefined"==typeof process?"undefined":_typeof(process))&&"function"==typeof require?this._environment="node":this._environment="shell",this._modelFilePath=r.modelFilePath||null,this._layers=[],this._msg_pck_fmt=r.msgPackFmt||!1,this._zig_zag_encoding=r.zigzagEncoding||!1}return _createClass(e,[{key:"init",value:function(e){if(!this._modelFilePath)throw new Error("no modelFilePath specified in config object.");var r=new XMLHttpRequest;r.open("GET",this._modelFilePath,!0),r.responseType="text",r.onload=function(){if(200!==r.status)return void console.error(r.status);var t=r.response;this._msg_pck_fmt?this._layers=unpack_from_msg(t,this._msg_pck_fmt,this._zig_zag_encoding):this._layers=JSON.parse(t),e()}.bind(this),r.responseType="arraybuffer",r.send()}},{key:"predict",value:function(e){var r=this,t=function(e){var t=!0,a=!1,n=void 0;try{for(var i,o=r._layers[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var s=i.value,u=s.layerName,l=s.parameters;e=layerFuncs[u].apply(layerFuncs,[r._arrayType,e].concat(_toConsumableArray(l)))}}catch(y){a=!0,n=y}finally{try{!t&&o["return"]&&o["return"]()}finally{if(a)throw n}}return e},a=(0,_ndarrayPack2["default"])(this._arrayType,e),n=t(a);return(0,_ndarrayUnpack2["default"])(n)}}]),e}();exports["default"]=NeuralNet;
}).call(this,require('_process'))
},{"./layers":39,"./lib/ndarray-pack":43,"_process":5,"msgpack-lite":12,"ndarray-unpack":34}]},{},[44])(44)
